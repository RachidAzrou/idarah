...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-xl bg-accent/50 backdrop-blur-sm p-1 text-muted-foreground shadow-sm border border-border/30",
      className
    )}
    {...props}
  />
